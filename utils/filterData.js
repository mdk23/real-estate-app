export const filterData=[
    ...
    },
    {
        items:[
            ...
            {name: 'Yearly', value:'monthly'},
        ],
        placeholder:'Rent Frequency',
        queryName:'rentFrenquency',
    },
...
export const getFilterValues=(filterValues)=>{
    ...
    const {purpose,rentFrenquency,minPrice,maxPrice,sort,areaMax,roomsMin,bathsMin,furnishingStatus,categoryExternalID}=filterValues;

    const values=[
        {name:'purpose',value:purpose},
        {name:'rentFrenquency',value:rentFrenquency},
